...
from dscode.conversation import (
    ConversationManager,
    Message,
    ToolResultBlock,
    estimate_tokens,
)
from dscode.serialization import build_messages
...
SESSION_SUBDIR = ".dscode/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from dscode.tools.base import StreamEnd, StreamEvent, TextDelta
