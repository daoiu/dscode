...
PROJECT_AGENTS_DIR = ".dscode/agents"
USER_AGENTS_DIR = "~/.dscode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("dscode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from dscode.agents.parser import parse_frontmatter, _validate_agent_meta
