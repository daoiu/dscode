...
def build_teammate_tools(
    ...
    from dscode.tools.send_message import SendMessageTool
    from dscode.tools.task_create import TaskCreateTool
    from dscode.tools.task_get import TaskGetTool
    from dscode.tools.task_list import TaskListTool
    from dscode.tools.task_update import TaskUpdateTool
