...
from dscode.tools.base import Tool
...
def create_default_registry(file_cache: FileCache | None = None, file_history: Any = None) -> ToolRegistry:
    from dscode.tools.bash import Bash
    from dscode.tools.edit_file import EditFile
    from dscode.tools.file_state_cache import FileStateCache
    from dscode.tools.glob import Glob
    from dscode.tools.grep import Grep
    from dscode.tools.read_file import ReadFile
    from dscode.tools.write_file import WriteFile
