...
from dscode.tools.base import Tool, ToolResult
...
if TYPE_CHECKING:
    ...
    from dscode.client import LLMClient
...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from dscode.agents.fork import ForkError, build_forked_messages
        from dscode.agents.parser import AgentDef
        from dscode.agents.tool_filter import resolve_agent_tools
        from dscode.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from dscode.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from dscode.agents.fork import ForkError, build_forked_messages
        from dscode.agents.parser import AgentDef
        from dscode.agents.tool_filter import build_teammate_tools
        from dscode.agent import Agent as AgentClass
        from dscode.conversation import ConversationManager
        from dscode.permissions import (
            DangerousCommandDetector,
        ...
        from dscode.teams.models import BackendType, TeammateInfo
        from dscode.teams.registry import AgentNameRegistry
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from dscode.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from dscode.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from dscode.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from dscode.client import create_client
        from dscode.config import ProviderConfig
