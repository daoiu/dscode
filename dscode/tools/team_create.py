...
class TeamCreateTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from dscode.teams.backend_detect import BackendDetectionError
        ...
        coordinator_note = ""
        from dscode.teams.coordinator import is_coordinator_mode
        if is_coordinator_mode(self._enable_coordinator_mode):
            from dscode.agents.tool_filter import apply_coordinator_filter
