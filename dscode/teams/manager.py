...
from dscode.teams.backend_detect import BackendDetectionError, detect_backend
from dscode.teams.mailbox import Mailbox, create_message
from dscode.teams.models import (
    AgentTeam,
    BackendType,
    TeammateInfo,
    resolve_team_dir,
...
from dscode.teams.progress import TeammateProgress
from dscode.teams.registry import AgentNameRegistry
from dscode.teams.shared_task import SharedTaskStore
from dscode.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from dscode.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
