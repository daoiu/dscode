...
from dscode.skills.parser import SkillDef, substitute_arguments
from dscode.tools import ToolRegistry

if TYPE_CHECKING:
    from dscode.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from dscode.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
